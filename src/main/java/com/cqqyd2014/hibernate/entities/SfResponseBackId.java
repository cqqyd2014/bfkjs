...
/**
 * SfResponseBackId generated by hbm2java
 */
@Embeddable
public class SfResponseBackId implements java.io.Serializable {

	private String comId;
	private String uuid;

	public SfResponseBackId() {
	}

	public SfResponseBackId(String comId, String uuid) {
		this.comId = comId;
		this.uuid = uuid;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SfResponseBackId))
			return false;
		SfResponseBackId castOther = (SfResponseBackId) other;
