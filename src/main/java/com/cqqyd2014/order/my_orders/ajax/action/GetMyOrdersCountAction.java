...
@Namespace("/order")
public class GetMyOrdersCountAction extends OrderCountAjaxAction{
	

	@Action(value = "get_my_ordres_count", results = { @Result(type = "json", params = { "root", "msg" }) }, interceptorRefs = {
...
@Authority(module = "get_goods_info", privilege = "[00010003]", error_url = "authority_ajax_error")
	...
	public java.math.BigInteger getCount(Session session, Date start_date, Date end_date, String com_id, String rows, String page,
		...
		return vomd.getOrderNoCount(session, start_date, end_date, com_id, orders, user_name, user_tell, goods_name, original_id, barcode, express_no,null,user_id,gts,emss);
