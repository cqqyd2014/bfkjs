...
/**
 * ReturnGoodsId generated by hbm2java
 */
@Embeddable
public class ReturnGoodsId implements java.io.Serializable {

	private String comId;
	private String uuid;

	public ReturnGoodsId() {
	}

	public ReturnGoodsId(String comId, String uuid) {
		this.comId = comId;
		this.uuid = uuid;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ReturnGoodsId))
			return false;
		ReturnGoodsId castOther = (ReturnGoodsId) other;
