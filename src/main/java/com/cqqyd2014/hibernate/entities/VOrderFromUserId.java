...
/**
 * VOrderFromUserId generated by hbm2java
 */
@Embeddable
public class VOrderFromUserId implements java.io.Serializable {
	...
	public VOrderFromUserId() {
	}

	public VOrderFromUserId(String EName, String EId, String orderTypeName, String orderTypeDesc, String seq,
			String comId, String orderTypeCode, String userId) {
		this.EName = EName;
		this.EId = EId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VOrderFromUserId))
			return false;
		VOrderFromUserId castOther = (VOrderFromUserId) other;
