...
/**
 * HttpErrorLogId generated by hbm2java
 */
@Embeddable
public class HttpErrorLogId implements java.io.Serializable {

	private String comId;
	private String uuid;

	public HttpErrorLogId() {
	}

	public HttpErrorLogId(String comId, String uuid) {
		this.comId = comId;
		this.uuid = uuid;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof HttpErrorLogId))
			return false;
		HttpErrorLogId castOther = (HttpErrorLogId) other;
