...
public class WareHouseDAO {
		...
		public String getHwTypeByHwName(Session session,String hwName,String com_id){
		...
		public  com.cqqyd2014.hibernate.entities.Warehouse getByHwType(Session session,String hw_type,String com_id){
		...
		public  java.util.ArrayList<com.cqqyd2014.wh.model.WareHouse> getModelByComId(Session session,String com_id){
		...
		public  java.util.LinkedHashMap<String, String> getUserWareHouseMapByComId(Session session,String com_id){
		...
		public  java.util.ArrayList<com.cqqyd2014.wh.model.WareHouse> getUserWareHouseModelByComId(Session session,String com_id){
			java.util.ArrayList<com.cqqyd2014.hibernate.entities.Warehouse> whs=getUserWarehose(session,com_id);
			java.util.ArrayList<com.cqqyd2014.wh.model.WareHouse> wh_models=new java.util.ArrayList<>();
			com.cqqyd2014.hibernate.dao.WareHouseStorageDAO wsdao=new com.cqqyd2014.hibernate.dao.WareHouseStorageDAO();
			for (int i=0;i<whs.size();i++){
		...
		public  java.util.ArrayList<com.cqqyd2014.wh.model.WareHouse> getUserCustomWareHouseModelByComId(Session session,String com_id){
		...
		//所有仓库
		public  java.util.ArrayList<com.cqqyd2014.hibernate.entities.Warehouse> getAllByComId(Session session,String com_id){
		...
		public java.util.ArrayList<com.cqqyd2014.hibernate.entities.Warehouse> getUserWarehose(Session session,String com_id){
		...
		public java.util.ArrayList<com.cqqyd2014.hibernate.entities.Warehouse> getUserCustomWarehose(Session session,String com_id){
		...
		public java.util.ArrayList<com.cqqyd2014.hibernate.entities.Warehouse> getAllByCity(Session session,String city,String com_id){
