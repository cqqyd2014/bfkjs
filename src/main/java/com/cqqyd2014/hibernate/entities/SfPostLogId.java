...
/**
 * SfPostLogId generated by hbm2java
 */
@Embeddable
public class SfPostLogId implements java.io.Serializable {
	...
	public SfPostLogId(String comId, String uuid) {
		this.comId = comId;
		this.uuid = uuid;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SfPostLogId))
			return false;
		SfPostLogId castOther = (SfPostLogId) other;
