...
<script type="text/javascript"
	src='../js/jquery-<s:property value="#application.jquery_version" />.min.js'>
	
</script>
<script type="text/javascript"
	src="../js/jquery-easyui-<s:property value='#application.easyui_version' />/jquery.easyui.min.js"></script>
