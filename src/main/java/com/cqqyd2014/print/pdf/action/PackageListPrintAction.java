...
public class PackageListPrintAction extends ActionSupport implements ServletResponseAware, ServletContextAware {
	...
	public InputStream getInputStream() {
		...
		try {
			...
			java.util.ArrayList<String> arraylist_orders = com.cqqyd2014.util.StringUtil
					.ArrayToArrayList(order_nos.split(","));
			java.util.ArrayList<String> arraylist_seqs = com.cqqyd2014.util.StringUtil
					.ArrayToArrayList(seqs.split(","));

			JRDataSource dataSource = createReportDataSource(session, arraylist_orders, arraylist_seqs, com_id);
			inputStream = new ByteArrayInputStream(
					JasperRunManager.runReportToPdf(inputStreamJasper, parameters, dataSource));
			tx.commit();
	...
	private JRDataSource createReportDataSource(Session session, java.util.ArrayList<String> arraylist_orders,
			java.util.ArrayList<String> arraylist_seqs, String com_id) throws Exception {
		JRBeanCollectionDataSource dataSource;

		java.util.ArrayList<com.cqqyd2014.order.model.DeliverBill> reportRows = com.cqqyd2014.order.logic.DeliverMLogic
				.getArrayListFullModelWithDetail(session, arraylist_orders, arraylist_seqs, com_id);
