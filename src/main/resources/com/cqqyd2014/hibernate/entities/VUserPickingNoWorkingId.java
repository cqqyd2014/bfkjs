...
/**
 * VUserPickingNoWorkingId generated by hbm2java
 */
@Embeddable
public class VUserPickingNoWorkingId implements java.io.Serializable {
	...
	public VUserPickingNoWorkingId() {
	}

	public VUserPickingNoWorkingId(String comId, Integer pickingCount, String id, BigDecimal pickupWeighting) {
		this.comId = comId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VUserPickingNoWorkingId))
			return false;
		VUserPickingNoWorkingId castOther = (VUserPickingNoWorkingId) other;
