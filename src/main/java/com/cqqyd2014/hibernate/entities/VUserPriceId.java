...
/**
 * VUserPriceId generated by hbm2java
 */
@Embeddable
public class VUserPriceId implements java.io.Serializable {
	...
	public VUserPriceId(String userpriceUuid, Boolean effective, String comId, String userId, String goodsId,
			BigDecimal userPrice, Date startTime, Date endTime, String CName, String unit) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VUserPriceId))
			return false;
		VUserPriceId castOther = (VUserPriceId) other;
