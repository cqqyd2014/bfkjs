		...
		try {
			...
			if (len==18) {
				...
				if (com.cqqyd2014.util.HashMapTools.check_if_contains(order_map,prepackage_map)) {
					...
					db.setMemo_barcodes(com.cqqyd2014.util.ArrayTools.convertFieldToArrayString(ppds, "getGoods_barcode",String.class));
					db.setMemo_names(com.cqqyd2014.util.ArrayTools.convertFieldToArrayString(ppds, "getGoods_name",String.class));
