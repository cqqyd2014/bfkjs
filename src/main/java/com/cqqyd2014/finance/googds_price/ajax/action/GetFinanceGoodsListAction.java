...
public class GetFinanceGoodsListAction  extends ActionSupport {
	...
	@Action(value = "get_goods_finance_price", results = { @Result(type = "json", params = { "root", "msg" }) })
	public String get_goods_finance_price() throws Exception {
...
Session session = HibernateSessionFactory.getSession();
		...
		try {
			...
			java.util.ArrayList<com.cqqyd2014.hibernate.entities.VFinanceGoodsPrice> vfgps_h=vfgpdao.getArrayListView(session, com_id);
