...
@Namespace("/wh")
public class GetUnPrintedPrepackageBarcodeAction  extends UserLoginedAction {
	...
	@Action(value = "get_unprinted_prepackage_barcode", results = { @Result(type = "json", params = { "root", "msg" })}, interceptorRefs = {
...
sm.setAuth_success(true);
		...
		try {
			...
			java.util.ArrayList<com.cqqyd2014.hibernate.entities.PrePackageM> ppms_h=ppdao.getUnPrintPreSn(session, com_id,user_id);
