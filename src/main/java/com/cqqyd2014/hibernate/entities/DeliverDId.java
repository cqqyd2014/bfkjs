...
/**
 * DeliverDId generated by hbm2java
 */
@Embeddable
public class DeliverDId implements java.io.Serializable {
	...
	public DeliverDId(String comId, String uuid) {
		this.comId = comId;
		this.uuid = uuid;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DeliverDId))
			return false;
		DeliverDId castOther = (DeliverDId) other;
