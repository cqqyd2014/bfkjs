...
/**
 * GoodsReturnDId generated by hbm2java
 */
@Embeddable
public class GoodsReturnDId implements java.io.Serializable {
	...
	public GoodsReturnDId() {
	}

	public GoodsReturnDId(String comId, String orderNo, String seq, String goodsBarcode) {
		this.comId = comId;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GoodsReturnDId))
			return false;
		GoodsReturnDId castOther = (GoodsReturnDId) other;
