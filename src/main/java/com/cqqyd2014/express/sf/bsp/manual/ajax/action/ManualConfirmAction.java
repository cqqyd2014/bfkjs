...
public class ManualConfirmAction   extends ActionSupport {
	...
	@Action(value = "manual_confirm", results = { @Result(type = "json", params = { "root", "msg" }) })
	public String manual_order() throws Exception {
		...
		try {
			...
			BspHttpClientOrderConfirm bhco1=new BspHttpClientOrderConfirm(session,db);
