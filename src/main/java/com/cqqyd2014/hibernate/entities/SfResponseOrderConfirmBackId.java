...
/**
 * SfResponseOrderConfirmBackId generated by hbm2java
 */
@Embeddable
public class SfResponseOrderConfirmBackId implements java.io.Serializable {

	private String comId;
	private String uuid;

	public SfResponseOrderConfirmBackId() {
	}

	public SfResponseOrderConfirmBackId(String comId, String uuid) {
		this.comId = comId;
		this.uuid = uuid;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof SfResponseOrderConfirmBackId))
			return false;
		SfResponseOrderConfirmBackId castOther = (SfResponseOrderConfirmBackId) other;
