...
@Namespace("/system")
public class AddProvince extends UserLoginedAction {
	...
	@Action(value = "add_province", results = { @Result(type = "json", params = { "root", "msg" }) }, interceptorRefs = {
			
			@InterceptorRef("defaultStack"),
			@InterceptorRef("authorityInterceptor") })
@Authority(module = "add_province", privilege = "*", error_url = "authority_ajax_error")
@Override
