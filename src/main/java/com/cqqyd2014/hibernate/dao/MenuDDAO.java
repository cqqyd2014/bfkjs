...
public class MenuDDAO {
	...
	*/
	public java.util.ArrayList<com.cqqyd2014.system.model.MenuD> getMenuDByMId(Session session,String com_id,String m_id,String user_id){
		String hql="from VUserMenuD where id.comId=:com_id and id.userId=:user_id and id.menuId=:m_id";
		Query q = session.createQuery(hql);
