					...
					userid:userid
						...
						var field=result.msg;
							...
							if (field.success) {
								...
								$('#new_deliver_express_no').textbox('setValue',dm.express_no);
...
<div id="print_logistics_bill" class="easyui-dialog"	title="打印模板" style="width: 600px; height: 400px; padding: 10px"
		data-options="
				iconCls: 'qyd',
				
				buttons: '#print_logistics_bill_buttons'
			">
	<div>当前快递有<span id="bill_count"></span>种快递模板，请选择打印模板</div>
	<div style="padding: 10px; width: 90%;" id="logistics_bills">
	
	</div>

</div>

<div id="print_logistics_bill_buttons">
	 <a href="javascript:void(0)"
		class="easyui-linkbutton"
		onclick="javascript:$('#print_logistics_bill').dialog('close')" iconCls="icon-ok">关闭选择运单模板窗口</a>
</div>
