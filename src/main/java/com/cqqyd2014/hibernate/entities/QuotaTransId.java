...
/**
 * QuotaTransId generated by hbm2java
 */
@Embeddable
public class QuotaTransId implements java.io.Serializable {
	...
	public QuotaTransId(String comId, String uuid) {
		this.comId = comId;
		this.uuid = uuid;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof QuotaTransId))
			return false;
		QuotaTransId castOther = (QuotaTransId) other;
